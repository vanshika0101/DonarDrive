...
async function sendOTPEmail(to_email) {
    let transporter = nodemailer.createTransport({
        ...
        auth: {
            user: "vanshikamalik139@gmail.com",
    ...
    try {
        ...
        let info = await transporter.sendMail({
            ...
            html: `<h2 style="color:red">Your OTP for DonarDrive</h2>
...
async function sendVerifyMail(to_email) {
    ...
    let info = await transporter.sendMail({
        to: to_email,
        from: "vanshikamalik139@gmail.com",
        subject: "Verify Your Email for DonarDrive",
